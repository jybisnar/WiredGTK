...
public class pmedication extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPatient.pmedication");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPatient.pmedication.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.objects.PanelWrapper _btnorder = null;
...
public anywheresoftware.b4a.objects.LabelWrapper _lbldispenses1 = null;
public anywheresoftware.b4a.objects.LabelWrapper _lbl_startstop2 = null;
public anywheresoftware.b4a.objects.LabelWrapper _lbldispenses2 = null;
...
public anywheresoftware.b4a.objects.LabelWrapper _lbldispenses3 = null;
...
b4a.OPTUMizerPatient.phome _home = null;
 //BA.debugLineNum = 130;BA.debugLine="Sub btnBack_click()";
 //BA.debugLineNum = 131;BA.debugLine="Dim home As PHome";
_home = new b4a.OPTUMizerPatient.phome();
 //BA.debugLineNum = 132;BA.debugLine="home=Starter.PHome1";
_home = (b4a.OPTUMizerPatient.phome)(_starter._phome1 /*Object*/ );
 //BA.debugLineNum = 133;BA.debugLine="home.Visible=True";
...
public String  _btnorder_click() throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Sub btnOrder_click()";
 //BA.debugLineNum = 129;BA.debugLine="End Sub";
return "";
}
public String  _btnqr_click() throws Exception{
b4a.OPTUMizerPatient.pqr _qrcode = null;
 //BA.debugLineNum = 136;BA.debugLine="Sub btnQr_click()";
 //BA.debugLineNum = 137;BA.debugLine="Dim qrCode As PQr";
_qrcode = new b4a.OPTUMizerPatient.pqr();
 //BA.debugLineNum = 138;BA.debugLine="qrCode=Starter.PQr1";
_qrcode = (b4a.OPTUMizerPatient.pqr)(_starter._pqr1 /*Object*/ );
 //BA.debugLineNum = 139;BA.debugLine="qrCode.Visible=True";
...
_image1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim btnOrder As Panel";
_btnorder = new anywheresoftware.b4a.objects.PanelWrapper();
...
_lbldesc1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim lblDispenses1 As Label";
_lbldispenses1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim lbl_startStop2 As Label";
_lbl_startstop2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim lblDispenses2 As Label";
_lbldispenses2 = new anywheresoftware.b4a.objects.LabelWrapper();
...
_lbl_startstop3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim lblDispenses3 As Label";
_lbldispenses3 = new anywheresoftware.b4a.objects.LabelWrapper();
...
public anywheresoftware.b4a.objects.PanelWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Public Sub GetBase As Panel";
 //BA.debugLineNum = 179;BA.debugLine="Return mBase";
if (true) return _mbase;
 //BA.debugLineNum = 180;BA.debugLine="End Sub";
return null;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Public Sub getVisible() As Boolean";
 //BA.debugLineNum = 169;BA.debugLine="Return mBase.Visible";
...
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"MedicationsSubModule-6e7dd.png",_image1.getWidth(),_image1.getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 107;BA.debugLine="mBase.AddView(btnOrder,0.28 * mBase.Width,0.30 *";
_mbase.AddView((android.view.View)(_btnorder.getObject()),(int) (0.28*_mbase.getWidth()),(int) (0.30*_mbase.getHeight()),(int) (0.41*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
...
_mbase.AddView((android.view.View)(_lbldesc1.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.45*_mbase.getHeight()),(int) (0.85*_mbase.getWidth()),(int) (0.12*_mbase.getHeight()));
 //BA.debugLineNum = 112;BA.debugLine="mBase.AddView(lblDispenses1,0.65 * mBase.Width,0.";
_mbase.AddView((android.view.View)(_lbldispenses1.getObject()),(int) (0.65*_mbase.getWidth()),(int) (0.40*_mbase.getHeight()),(int) (0.27*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
...
_mbase.AddView((android.view.View)(_lbl_startstop2.getObject()),(int) (0.20*_mbase.getWidth()),(int) (0.60*_mbase.getHeight()),(int) (0.46*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 114;BA.debugLine="mBase.AddView(lblDispenses2,0.65 * mBase.Width,0.";
_mbase.AddView((android.view.View)(_lbldispenses2.getObject()),(int) (0.65*_mbase.getWidth()),(int) (0.60*_mbase.getHeight()),(int) (0.27*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
...
_mbase.AddView((android.view.View)(_lbl_startstop3.getObject()),(int) (0.20*_mbase.getWidth()),(int) (0.81*_mbase.getHeight()),(int) (0.46*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 117;BA.debugLine="mBase.AddView(lblDispenses3,0.65 * mBase.Width,0.";
_mbase.AddView((android.view.View)(_lbldispenses3.getObject()),(int) (0.65*_mbase.getWidth()),(int) (0.81*_mbase.getHeight()),(int) (0.27*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
...
public String  _init_pmedication() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Sub init_PMedication";
 //BA.debugLineNum = 61;BA.debugLine="btnOrder.Color =  0x0000979f";
_btnorder.setColor((int) (0x0000979f));
 //BA.debugLineNum = 62;BA.debugLine="btnBack.Color =  0x00008b67";
_btnback.setColor((int) (0x00008b67));
 //BA.debugLineNum = 63;BA.debugLine="btnQr.Color =  0x00008b67";
_btnqr.setColor((int) (0x00008b67));
...
_lbldesc1.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 72;BA.debugLine="lblDispenses1.Color =  0x00ffffff";
_lbldispenses1.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 73;BA.debugLine="lblDispenses1.TextColor = 0xff000000";
_lbldispenses1.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 74;BA.debugLine="lblDispenses1.Gravity = Gravity.CENTER_HORIZONTAL";
_lbldispenses1.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 75;BA.debugLine="lblDispenses1.Text = \"\"";
_lbldispenses1.setText(BA.ObjectToCharSequence(""));
...
_lbl_startstop2.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 80;BA.debugLine="lblDispenses2.Color =  0x00ffffff";
_lbldispenses2.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 81;BA.debugLine="lblDispenses2.TextColor = 0xff000000";
_lbldispenses2.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 82;BA.debugLine="lblDispenses2.Gravity = Gravity.CENTER_HORIZONTAL";
_lbldispenses2.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 83;BA.debugLine="lblDispenses2.Text = \"\"";
_lbldispenses2.setText(BA.ObjectToCharSequence(""));
...
_lbl_startstop3.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 92;BA.debugLine="lblDispenses3.Color =  0x00ffffff";
_lbldispenses3.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 93;BA.debugLine="lblDispenses3.TextColor = 0xff000000";
_lbldispenses3.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 94;BA.debugLine="lblDispenses3.Gravity = Gravity.CENTER_HORIZONTAL";
_lbldispenses3.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 95;BA.debugLine="lblDispenses3.Text = \"\"";
_lbldispenses3.setText(BA.ObjectToCharSequence(""));
...
_image1.Initialize(ba,"Image1");
 //BA.debugLineNum = 40;BA.debugLine="btnOrder.Initialize(\"btnOrder\")";
_btnorder.Initialize(ba,"btnOrder");
...
_lbldesc1.Initialize(ba,"lblDesc1");
 //BA.debugLineNum = 45;BA.debugLine="lblDispenses1.Initialize(\"lblDispenses1\")";
_lbldispenses1.Initialize(ba,"lblDispenses1");
 //BA.debugLineNum = 46;BA.debugLine="lbl_startStop2.Initialize(\"lbl_startStop2\")";
_lbl_startstop2.Initialize(ba,"lbl_startStop2");
 //BA.debugLineNum = 47;BA.debugLine="lblDispenses2.Initialize(\"lblDispenses2\")";
_lbldispenses2.Initialize(ba,"lblDispenses2");
...
_lbl_startstop3.Initialize(ba,"lbl_startStop3");
 //BA.debugLineNum = 50;BA.debugLine="lblDispenses3.Initialize(\"lblDispenses3\")";
_lbldispenses3.Initialize(ba,"lblDispenses3");
...
public String  _lbl_startstop1_click() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub lbl_startStop1_click()";
 //BA.debugLineNum = 145;BA.debugLine="End Sub";
return "";
}
public String  _lbl_startstop2_click() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub lbl_startStop2_click()";
 //BA.debugLineNum = 156;BA.debugLine="End Sub";
return "";
}
public String  _lbl_startstop3_click() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Sub lbl_startStop3_click()";
 //BA.debugLineNum = 162;BA.debugLine="End Sub";
return "";
}
public String  _lbldesc1_click() throws Exception{
 //BA.debugLineNum = 146;BA.debugLine="Sub lblDesc1_click()";
 //BA.debugLineNum = 151;BA.debugLine="End Sub";
return "";
}
public String  _lbldesc2_click() throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Sub lblDesc2_click()";
 //BA.debugLineNum = 160;BA.debugLine="End Sub";
return "";
}
public String  _lbldesc3_click() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Sub lblDesc3_click()";
 //BA.debugLineNum = 166;BA.debugLine="End Sub";
return "";
}
public String  _lbldispenses1_click() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Sub lblDispenses1_click()";
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public String  _lbldispenses2_click() throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Sub lblDispenses2_click()";
 //BA.debugLineNum = 158;BA.debugLine="End Sub";
return "";
}
public String  _lbldispenses3_click() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub lblDispenses3_click()";
 //BA.debugLineNum = 164;BA.debugLine="End Sub";
return "";
}
public String  _setlayout(int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Public Sub SetLayout(Left As Int,Top As Int,Width";
 //BA.debugLineNum = 175;BA.debugLine="mBase.SetLayout(Left,Top,Width,Height )";
_mbase.SetLayout(_left,_top,_width,_height);
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _flag) throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Public Sub setVisible(flag As Boolean)";
 //BA.debugLineNum = 172;BA.debugLine="mBase.Visible=flag";
