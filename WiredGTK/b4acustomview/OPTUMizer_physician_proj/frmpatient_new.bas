...
Public Sub GTKForms
	...
	mBase.AddView(btnLogIn,0.12 * mBase.Width,0.76 * mBase.Height,0.75 * mBase.Width,0.05 * mBase.Height)
	btnLogIn.Color =  0xff001f59
	mBase.AddView(txtID,0.14 * mBase.Width,0.60 * mBase.Height,0.74 * mBase.Width,0.05 * mBase.Height)
	mBase.AddView(txtPassword,0.14 * mBase.Width,0.67 * mBase.Height,0.74 * mBase.Width,0.06 * mBase.Height)
