...
public class wtaserver extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPhysician.wtaserver");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPhysician.wtaserver.class).invoke(this, new Object[] {null});
        else
...
_wsh.Close();
 //BA.debugLineNum = 31;BA.debugLine="Msgbox(\"Please Try Again\",\"Error Connecting\")";
__c.Msgbox(BA.ObjectToCharSequence("Please Try Again"),BA.ObjectToCharSequence("Error Connecting"),getActivityBA());
 };
