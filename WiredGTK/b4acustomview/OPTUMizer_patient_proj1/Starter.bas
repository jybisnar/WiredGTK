...
Sub Process_Globals
	...
	, encounterProblem As String, specialty As String)
	
	Dim user As MyType
	
	Dim serverURL As String="192.168.43.210" 'Change to your local IPv6 address
...
Sub Service_Create
	...
	user.Initialize()
	user.Id=" " 'This will get overridden by the back end.
	user.Prefix=" "
	user.First=" "
	user.Last=" "
	user.Address=" "
