...
public Sub add_data(t1 As String,t2 As String)
	'declare num,panellist
	'comment layout2 in GTKForms
	...
	Button1.Initialize("Button1")
	Button2.Initialize("Button2")
	Layout2.Width=1 * Layout1.Width
	Layout2.Height=0.22 * Layout1.Height
	''''''''''''
