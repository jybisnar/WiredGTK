...
public class bluetooth extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPatient.bluetooth");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPatient.bluetooth.class).invoke(this, new Object[] {null});
        else
...
public String  _check_bluetooth() throws Exception{
...
b4a.OPTUMizerPatient.frmcontrols _x = null;
 ...
 //BA.debugLineNum = 84;BA.debugLine="Dim x As frmcontrols";
_x = new b4a.OPTUMizerPatient.frmcontrols();
 //BA.debugLineNum = 85;BA.debugLine="x=Starter.frmcontrols1";
_x = (b4a.OPTUMizerPatient.frmcontrols)(_starter._frmcontrols1 /*Object*/ );
 //BA.debugLineNum = 86;BA.debugLine="x.Visible=True";
