...
table.__c.runVoidMethod ("LogImpl","25046274",RemoteObject.createImmutable("Wrong number of values."),0);
...
__ref.runClassMethod (b4a.raks.table.class, "_showrow" /*RemoteObject*/ ,(Object)(_lastrow));
 };
...
__ref.runClassMethod (b4a.raks.table.class, "_sv_scrollchanged" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
RemoteObject _rc = RemoteObject.declareNull("b4a.raks.table._rowcol");
...
_rc = RemoteObject.createNew ("b4a.raks.table._rowcol");Debug.locals.put("rc", _rc);
...
Debug.ShouldStop(4);
__ref.runClassMethod (b4a.raks.table.class, "_selectrow" /*RemoteObject*/ ,(Object)(_rc.getField(true,"Row" /*RemoteObject*/ )));
...
Debug.ShouldStop(128);
__ref.runClassMethod (b4a.raks.table.class, "_innerclearall" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_numberofcolumns" /*RemoteObject*/ )));
...
Debug.ShouldStop(131072);
_lbls = __ref.runClassMethod (b4a.raks.table.class, "_createnewlabels" /*RemoteObject*/ );Debug.locals.put("lbls", _lbls);
 };
...
Debug.ShouldStop(1);
table.__c.runVoidMethod ("LogImpl","25242885",RemoteObject.concat(RemoteObject.createImmutable("HideRow: (null) "),_row),0);
...
Debug.ShouldStop(4);
__ref.runClassMethod (b4a.raks.table.class, "_innerclearall" /*RemoteObject*/ ,(Object)(_vnumberofcolumns));
...
Debug.ShouldStop(134217728);
__ref.getField(false,"_labelscache" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.raks.table.class, "_createnewlabels" /*RemoteObject*/ ))));
 }
}Debug.locals.put("i", _i);
;
...
Debug.ShouldStop(524288);
__ref.runClassMethod (b4a.raks.table.class, "_innerclearall" /*RemoteObject*/ ,(Object)(_h.getField(true,"length")));
 BA.debugLineNum = 341;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
Debug.ShouldStop(1048576);
__ref.setField ("_columnwidth" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(true,"getWidth"),__ref.getField(true,"_numberofcolumns" /*RemoteObject*/ )}, "/",0, 0)));
 BA.debugLineNum = 342;BA.debugLine="SetHeader(h)";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4a.raks.table.class, "_setheader" /*RemoteObject*/ ,(Object)(_h));
...
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4a.raks.table.class, "_addrow" /*RemoteObject*/ ,(Object)(_row));
 }
}Debug.locals.put("i", _i);
;
...
Debug.ShouldStop(2048);
__ref.runClassMethod (b4a.raks.table.class, "_hiderow" /*RemoteObject*/ ,(Object)(_prev));
 BA.debugLineNum = 301;BA.debugLine="ShowRow(prev)";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4a.raks.table.class, "_showrow" /*RemoteObject*/ ,(Object)(_prev));
 };
 };
...
Debug.ShouldStop(262144);
__ref.runClassMethod (b4a.raks.table.class, "_hiderow" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selectedrow" /*RemoteObject*/ )));
 BA.debugLineNum = 308;BA.debugLine="ShowRow(SelectedRow)";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4a.raks.table.class, "_showrow" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_selectedrow" /*RemoteObject*/ )));
 };
 }
}Debug.locals.put("col", _col);
;
...
Debug.ShouldStop(1073741824);
__ref.runClassMethod (b4a.raks.table.class, "_innerclearall" /*RemoteObject*/ ,(Object)(_headerx.getField(true,"length")));
 BA.debugLineNum = 352;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
Debug.ShouldStop(-2147483648);
__ref.setField ("_columnwidth" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(true,"getWidth"),__ref.getField(true,"_numberofcolumns" /*RemoteObject*/ )}, "/",0, 0)));
 BA.debugLineNum = 353;BA.debugLine="SetHeader(HeaderX)";
Debug.ShouldStop(1);
__ref.runClassMethod (b4a.raks.table.class, "_setheader" /*RemoteObject*/ ,(Object)(_headerx));
...
Debug.ShouldStop(4);
__ref.runClassMethod (b4a.raks.table.class, "_addrow" /*RemoteObject*/ ,(Object)((_a)));
 }
}Debug.locals.put("a", _a);
;
...
Debug.ShouldStop(8);
_lbls = __ref.runClassMethod (b4a.raks.table.class, "_getlabels" /*RemoteObject*/ ,(Object)(_row));Debug.locals.put("lbls", _lbls);
...
Debug.ShouldStop(1024);
__ref.runClassMethod (b4a.raks.table.class, "_hiderow" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)));
 }
}Debug.locals.put("I", _i);
;
 }else 
...
Debug.ShouldStop(32768);
__ref.runClassMethod (b4a.raks.table.class, "_showrow" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)));
 }
}Debug.locals.put("I", _i);
;
 }}
