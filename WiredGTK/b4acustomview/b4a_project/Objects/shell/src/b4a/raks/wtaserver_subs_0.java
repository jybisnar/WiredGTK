...
try {
		Debug.PushSubsStack("CheckConnection (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("Initialize (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("InitWTAServer (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,79);
...
if (__ref.runClassMethod (b4a.raks.wtaserver.class, "_checkconnection" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
...
__ref.getField(false,"_wsh" /*RemoteObject*/ ).runVoidMethod ("Connect",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("107.180.92.29")),(Object)(BA.numberCast(int.class, 5001)),(Object)(BA.numberCast(int.class, 30000)));
 };
...
try {
		Debug.PushSubsStack("SendClient (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,55);
...
__ref.runClassMethod (b4a.raks.wtaserver.class, "_initwtaserver" /*RemoteObject*/ );
 };
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e10) {
...
try {
		Debug.PushSubsStack("SendServer (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("tmrwtaserver_Tick (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,93);
...
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4a.raks.wtaserver.class, "_sendserver" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("x")));
...
try {
		Debug.PushSubsStack("wsh_Connected (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("wsh_NewData (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("wtaserver_Error (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("wtaserver_Terminated (wtaserver) ","wtaserver",4,__ref.getField(false, "ba"),__ref,69);
