...
public class pprofile extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPatient.pprofile");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPatient.pprofile.class).invoke(this, new Object[] {null});
        else
...
b4a.OPTUMizerPatient.phome _home = null;
 ...
 //BA.debugLineNum = 122;BA.debugLine="Dim home As PHome";
_home = new b4a.OPTUMizerPatient.phome();
 //BA.debugLineNum = 123;BA.debugLine="home=Starter.PHome1";
...
b4a.OPTUMizerPatient.plogin _p_logout = null;
 //BA.debugLineNum = 109;BA.debugLine="Sub btnLogout_click()";
 //BA.debugLineNum = 110;BA.debugLine="Dim p_Logout As PLogin";
_p_logout = new b4a.OPTUMizerPatient.plogin();
 //BA.debugLineNum = 111;BA.debugLine="p_Logout=Starter.PLogin1";
_p_logout = (b4a.OPTUMizerPatient.plogin)(_starter._plogin1 /*Object*/ );
 //BA.debugLineNum = 112;BA.debugLine="p_Logout.Visible=True";
_p_logout._setvisible /*boolean*/ (__c.True);
...
b4a.OPTUMizerPatient.pqr _qrcode = null;
 //BA.debugLineNum = 115;BA.debugLine="Sub btnQr_click()";
 //BA.debugLineNum = 116;BA.debugLine="Dim qrCode As PQr";
_qrcode = new b4a.OPTUMizerPatient.pqr();
 //BA.debugLineNum = 117;BA.debugLine="qrCode=Starter.PQr1";
_qrcode = (b4a.OPTUMizerPatient.pqr)(_starter._pqr1 /*Object*/ );
 //BA.debugLineNum = 118;BA.debugLine="qrCode.Visible=True";
...
public anywheresoftware.b4a.objects.PanelWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Public Sub GetBase As Panel";
 //BA.debugLineNum = 157;BA.debugLine="Return mBase";
...
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"ProfileSubModule-783e7.png",_image1.getWidth(),_image1.getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 90;BA.debugLine="mBase.AddView(btnLogout,0.34 * mBase.Width,0.92 *";
_mbase.AddView((android.view.View)(_btnlogout.getObject()),(int) (0.34*_mbase.getWidth()),(int) (0.92*_mbase.getHeight()),(int) (0.32*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 91;BA.debugLine="mBase.AddView(btnQr,0.82 * mBase.Width,0.02 * mBa";
_mbase.AddView((android.view.View)(_btnqr.getObject()),(int) (0.82*_mbase.getWidth()),(int) (0.02*_mbase.getHeight()),(int) (0.12*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 92;BA.debugLine="mBase.AddView(btnBack,0.04 * mBase.Width,0.02 * m";
_mbase.AddView((android.view.View)(_btnback.getObject()),(int) (0.04*_mbase.getWidth()),(int) (0.02*_mbase.getHeight()),(int) (0.12*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 93;BA.debugLine="mBase.AddView(lblName,0.08 * mBase.Width,0.36 * m";
_mbase.AddView((android.view.View)(_lblname.getObject()),(int) (0.08*_mbase.getWidth()),(int) (0.36*_mbase.getHeight()),(int) (0.84*_mbase.getWidth()),(int) (0.08*_mbase.getHeight()));
 //BA.debugLineNum = 94;BA.debugLine="mBase.AddView(lbl_ID,0.07 * mBase.Width,0.59 * mB";
_mbase.AddView((android.view.View)(_lbl_id.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.59*_mbase.getHeight()),(int) (0.86*_mbase.getWidth()),(int) (0.04*_mbase.getHeight()));
 //BA.debugLineNum = 95;BA.debugLine="mBase.AddView(lblAddress,0.07 * mBase.Width,0.67";
_mbase.AddView((android.view.View)(_lbladdress.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.67*_mbase.getHeight()),(int) (0.86*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 96;BA.debugLine="mBase.AddView(lblCounty,0.07 * mBase.Width,0.76 *";
_mbase.AddView((android.view.View)(_lblcounty.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.76*_mbase.getHeight()),(int) (0.36*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 97;BA.debugLine="mBase.AddView(lblZip,0.53 * mBase.Width,0.76 * mB";
_mbase.AddView((android.view.View)(_lblzip.getObject()),(int) (0.53*_mbase.getWidth()),(int) (0.76*_mbase.getHeight()),(int) (0.41*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 98;BA.debugLine="mBase.AddView(lblState,0.07 * mBase.Width,0.84 *";
_mbase.AddView((android.view.View)(_lblstate.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.84*_mbase.getHeight()),(int) (0.86*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 100;BA.debugLine="initpatient_Profile";
_initpatient_profile();
 //BA.debugLineNum = 102;BA.debugLine="End Sub";
return "";
}
public String  _image1_click() throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub Image1_click()";
...
public String  _initpatient_profile() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub initpatient_Profile";
...
public String  _lbl_id_click() throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Sub lbl_ID_click()";
 //BA.debugLineNum = 132;BA.debugLine="End Sub";
return "";
}
public String  _lbladdress_click() throws Exception{
 //BA.debugLineNum = 133;BA.debugLine="Sub lblAddress_click()";
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public String  _lblcounty_click() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub lblCounty_click()";
 //BA.debugLineNum = 138;BA.debugLine="End Sub";
return "";
}
public String  _lblname_click() throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Sub lblName_click()";
 //BA.debugLineNum = 129;BA.debugLine="End Sub";
return "";
}
public String  _lblstate_click() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub lblState_click()";
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return "";
}
public String  _lblzip_click() throws Exception{
 //BA.debugLineNum = 139;BA.debugLine="Sub lblZip_click()";
 //BA.debugLineNum = 141;BA.debugLine="End Sub";
return "";
}
public String  _setlayout(int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Public Sub SetLayout(Left As Int,Top As Int,Width";
 //BA.debugLineNum = 153;BA.debugLine="mBase.SetLayout(Left,Top,Width,Height )";
_mbase.SetLayout(_left,_top,_width,_height);
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _flag) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Public Sub setVisible(flag As Boolean)";
 //BA.debugLineNum = 150;BA.debugLine="mBase.Visible=flag";
