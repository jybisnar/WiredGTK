...
public static b4a.OPTUMizerPhysician.starter._mytype _user = null;
...
public static String  _conns(int _res,anywheresoftware.b4a.objects.collections.Map _paireddevices,anywheresoftware.b4a.objects.collections.List _l) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub conns(res As Int, PairedDevices As Map, L As L";
 //BA.debugLineNum = 97;BA.debugLine="Serial1.Connect3(PairedDevices.Get(L.Get(res)),1)";
...
float _lon = 0f;
String _speed = "";
 //BA.debugLineNum = 199;BA.debugLine="Sub GPS_LocationChanged (Location1 As Location)";
 //BA.debugLineNum = 200;BA.debugLine="Dim lat As Float= NumberFormat(Location1.Latitude";
_lat = (float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_location1.getLatitude(),(int) (1),(int) (6))));
 //BA.debugLineNum = 201;BA.debugLine="Dim lon As Float= NumberFormat(Location1.Longitud";
_lon = (float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_location1.getLongitude(),(int) (1),(int) (6))));
 //BA.debugLineNum = 202;BA.debugLine="Dim speed As String = \"Speed = \" & Location1.Spee";
_speed = "Speed = "+BA.NumberToString(_location1.getSpeed());
 //BA.debugLineNum = 203;BA.debugLine="If wsh.connected=True Then";
if (_wsh._connected /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 204;BA.debugLine="wsh.SendClient(\"WTAGPS\" & lat & \",\" & lon & \",\"";
...
b4a.OPTUMizerPhysician.bluetooth _bluetooth = null;
 //BA.debugLineNum = 135;BA.debugLine="Sub mnuConnect_Click";
 //BA.debugLineNum = 136;BA.debugLine="Dim PairedDevices As Map";
_paireddevices = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 137;BA.debugLine="If connected_BT=False Then";
if (_connected_bt==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 138;BA.debugLine="PairedDevices = Serial1.GetPairedDevices";
_paireddevices = _serial1.GetPairedDevices();
 //BA.debugLineNum = 139;BA.debugLine="Dim L As List";
_l = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 140;BA.debugLine="L.Initialize";
_l.Initialize();
 //BA.debugLineNum = 141;BA.debugLine="For i = 0 To PairedDevices.Size - 1";
{
final int step6 = 1;
final int limit6 = (int) (_paireddevices.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit6 ;_i = _i + step6 ) {
 //BA.debugLineNum = 142;BA.debugLine="L.Add(PairedDevices.GetKeyAt(i)) 'add the frien";
_l.Add(_paireddevices.GetKeyAt(_i));
 }
};
 //BA.debugLineNum = 144;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 145;BA.debugLine="Dim bluetooth As bluetooth=bluetoothview1";
_bluetooth = (b4a.OPTUMizerPhysician.bluetooth)(_bluetoothview1);
 //BA.debugLineNum = 146;BA.debugLine="res=CallSub2(bluetooth,\"Getlist\",L)";
_res = (int)(BA.ObjectToNumber(anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(_bluetooth),"Getlist",(Object)(_l))));
 //BA.debugLineNum = 148;BA.debugLine="If res <> DialogResponse.CANCEL Then";
if (_res!=anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 151;BA.debugLine="Serial1.Connect3(PairedDevices.Get(L.Get(res))";
_serial1.Connect3(processBA,BA.ObjectToString(_paireddevices.Get(_l.Get(_res))),(int) (1));
 };
 };
...
public static String  _mnudisconnect_click() throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub mnuDisconnect_Click";
 //BA.debugLineNum = 89;BA.debugLine="If connected_BT=True Then";
if (_connected_bt==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 90;BA.debugLine="astream.Close";
_astream.Close();
 //BA.debugLineNum = 91;BA.debugLine="timer1.Enabled=False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 92;BA.debugLine="Serial1.Disconnect";
_serial1.Disconnect();
 //BA.debugLineNum = 93;BA.debugLine="connected_BT=False";
...
public static String  _msec(int _xa) throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub msec(xa As Int)";
 //BA.debugLineNum = 178;BA.debugLine="msec_ = xa";
_msec_ = _xa;
 //BA.debugLineNum = 179;BA.debugLine="Do While(msec_<>0)";
while ((_msec_!=0)) {
...
String _x = "";
 //BA.debugLineNum = 169;BA.debugLine="public Sub Println(str As String)";
 //BA.debugLineNum = 170;BA.debugLine="Dim x As String";
_x = "";
 //BA.debugLineNum = 171;BA.debugLine="str=str&Chr(13)";
_str = _str+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 172;BA.debugLine="x=str.Length";
_x = BA.NumberToString(_str.length());
 //BA.debugLineNum = 173;BA.debugLine="If connected_BT=True Then";
if (_connected_bt==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 174;BA.debugLine="astream.Write(str.GetBytes(\"UTF8\"))";
...
_dpatientmedhistory1 = new Object();
 //BA.debugLineNum = 50;BA.debugLine="Type MyType (Id As String, Name As String)";
;
 //BA.debugLineNum = 51;BA.debugLine="Dim user As MyType";
_user = new b4a.OPTUMizerPhysician.starter._mytype();
 //BA.debugLineNum = 53;BA.debugLine="Dim serverURL As String=\"192.168.43.174\"";
_serverurl = "192.168.43.174";
 //BA.debugLineNum = 54;BA.debugLine="End Sub";
return "";
}
public static String  _serial1_connected(boolean _success) throws Exception{
b4a.OPTUMizerPhysician.bluetooth _bluetooth = null;
 //BA.debugLineNum = 100;BA.debugLine="Sub Serial1_Connected (Success As Boolean)";
 //BA.debugLineNum = 101;BA.debugLine="Dim bluetooth As bluetooth=bluetoothview1";
_bluetooth = (b4a.OPTUMizerPhysician.bluetooth)(_bluetoothview1);
 //BA.debugLineNum = 102;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 103;BA.debugLine="ToastMessageShow(\"Connected successfully\", False";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="timer1.Initialize(\"Timer1\",1000*60)'one minute";
_timer1.Initialize(processBA,"Timer1",(long) (1000*60));
 //BA.debugLineNum = 61;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="sms_rx.Initialize(\"sms_rx\")";
_sms_rx.Initialize("sms_rx",processBA);
 //BA.debugLineNum = 63;BA.debugLine="Serial1.Initialize(\"Serial1\")";
_serial1.Initialize("Serial1");
 //BA.debugLineNum = 64;BA.debugLine="user.Initialize()";
_user.Initialize();
 //BA.debugLineNum = 65;BA.debugLine="user.Id = \" \"";
_user.Id /*String*/  = " ";
 //BA.debugLineNum = 66;BA.debugLine="user.Name = \" \"";
_user.Name /*String*/  = " ";
 //BA.debugLineNum = 68;BA.debugLine="customview.Initialize";
_customview.Initialize();
 //BA.debugLineNum = 69;BA.debugLine="myparser.Initialize(\"WTA\",Chr(13),1)";
_myparser._initialize /*String*/ (processBA,"WTA",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13))),(int) (1));
 //BA.debugLineNum = 70;BA.debugLine="volt.Initialize(\"Volt RMS: \",\"A\",1)";
_volt._initialize /*String*/ (processBA,"Volt RMS: ","A",(int) (1));
 //BA.debugLineNum = 71;BA.debugLine="energy.Initialize(\"Watt-Hour: \",\"I\",1)";
_energy._initialize /*String*/ (processBA,"Watt-Hour: ","I",(int) (1));
 //BA.debugLineNum = 72;BA.debugLine="amp.Initialize(\"Amp RMS: \",\"R\",1)";
_amp._initialize /*String*/ (processBA,"Amp RMS: ","R",(int) (1));
 //BA.debugLineNum = 73;BA.debugLine="powerWatt.Initialize(\"Real Power: \",\"V\",1)";
_powerwatt._initialize /*String*/ (processBA,"Real Power: ","V",(int) (1));
 //BA.debugLineNum = 74;BA.debugLine="parse1.Initialize(\"GETVAL$\",\"#\",1)";
...
public static String  _service_destroy() throws Exception{
 ...
 //BA.debugLineNum = 196;BA.debugLine="ToastMessageShow(\"exit\",True)";
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
...
int _aa = 0;
String _z = "";
 //BA.debugLineNum = 121;BA.debugLine="Sub sms_rx_MessageReceived(From As String, Body As";
 //BA.debugLineNum = 122;BA.debugLine="Dim strsend As String";
_strsend = "";
 //BA.debugLineNum = 123;BA.debugLine="If Body=\"Hello\" Then";
if ((_body).equals("Hello")) { 
 //BA.debugLineNum = 124;BA.debugLine="sms.Send(From,\"what the hell\")";
_sms.Send(_from,"what the hell");
 };
 //BA.debugLineNum = 126;BA.debugLine="Dim aa As Int";
_aa = 0;
 //BA.debugLineNum = 127;BA.debugLine="For aa = 0 To Body.Length-1";
{
final int step6 = 1;
final int limit6 = (int) (_body.length()-1);
_aa = (int) (0) ;
for (;_aa <= limit6 ;_aa = _aa + step6 ) {
 //BA.debugLineNum = 128;BA.debugLine="Dim z As String";
_z = "";
 //BA.debugLineNum = 129;BA.debugLine="z=Body.SubString2(aa,aa+1)";
_z = _body.substring(_aa,(int) (_aa+1));
 //BA.debugLineNum = 130;BA.debugLine="If myparser.available(z)=True Then";
if (_myparser._available /*boolean*/ (_z)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="ToastMessageShow(myparser.data,False)";
...
String _strs = "";
 //BA.debugLineNum = 158;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 159;BA.debugLine="ToastMessageShow(\"saving logs to power_log.csv\",T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("saving logs to power_log.csv"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 161;BA.debugLine="If File.Exists(File.DirRootExternal, \"power_log.c";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"power_log.csv")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 162;BA.debugLine="Dim strs As String=vb6.GetFileStr(\"power_log.csv";
_strs = mostCurrent._vb6._getfilestr /*String*/ (processBA,"power_log.csv");
 //BA.debugLineNum = 163;BA.debugLine="strs=strs&voltx&\",\"&ampx&\",\"&powerWattx&\",\"&ener";
_strs = _strs+_voltx+","+_ampx+","+_powerwattx+","+_energyx+","+mostCurrent._vb6._now /*String*/ (processBA)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 164;BA.debugLine="vb6.SaveFileStr(\"power_log.csv\",strs)";
mostCurrent._vb6._savefilestr /*String*/ (processBA,"power_log.csv",_strs);
 }else {
 //BA.debugLineNum = 166;BA.debugLine="vb6.SaveFileStr(\"power_log.csv\",\"Volt,Current,Po";
...
int _aa = 0;
String _z = "";
 //BA.debugLineNum = 77;BA.debugLine="Sub wsh_NewData(data As String)";
 //BA.debugLineNum = 78;BA.debugLine="ToastMessageShow(data,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_data),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 79;BA.debugLine="Dim aa As Int";
_aa = 0;
 //BA.debugLineNum = 80;BA.debugLine="For aa = 0 To data.Length-1";
{
final int step3 = 1;
final int limit3 = (int) (_data.length()-1);
_aa = (int) (0) ;
for (;_aa <= limit3 ;_aa = _aa + step3 ) {
 //BA.debugLineNum = 81;BA.debugLine="Dim z As String";
_z = "";
 //BA.debugLineNum = 82;BA.debugLine="z=data.SubString2(aa,aa+1)";
_z = _data.substring(_aa,(int) (_aa+1));
 //BA.debugLineNum = 83;BA.debugLine="If parse1.available(z)=True Then";
if (_parse1._available /*boolean*/ (_z)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 84;BA.debugLine="ToastMessageShow(parse1.data,False)";
