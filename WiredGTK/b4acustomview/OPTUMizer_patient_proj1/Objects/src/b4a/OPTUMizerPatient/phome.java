...
b4a.OPTUMizerPatient.pappointment _p_appointment = null;
 //BA.debugLineNum = 157;BA.debugLine="Sub btnAppointments_click()";
 //BA.debugLineNum = 158;BA.debugLine="Dim p_Appointment As PAppointment";
_p_appointment = new b4a.OPTUMizerPatient.pappointment();
 //BA.debugLineNum = 159;BA.debugLine="p_Appointment=Starter.PAppointment1";
_p_appointment = (b4a.OPTUMizerPatient.pappointment)(_starter._pappointment1 /*Object*/ );
 //BA.debugLineNum = 160;BA.debugLine="p_Appointment.Visible=True";
_p_appointment._setvisible /*boolean*/ (__c.True);
 //BA.debugLineNum = 161;BA.debugLine="setVisible(False)";
_setvisible(__c.False);
 //BA.debugLineNum = 162;BA.debugLine="End Sub";
return "";
}
public String  _btnhotline_click() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub btnHotline_click()";
 //BA.debugLineNum = 165;BA.debugLine="End Sub";
return "";
}
public String  _btnlogs_click() throws Exception{
b4a.OPTUMizerPatient.plogs _p_log = null;
 //BA.debugLineNum = 172;BA.debugLine="Sub btnLogs_click()";
 //BA.debugLineNum = 173;BA.debugLine="Dim p_Log As PLogs";
_p_log = new b4a.OPTUMizerPatient.plogs();
 //BA.debugLineNum = 174;BA.debugLine="p_Log=Starter.PLogs1";
_p_log = (b4a.OPTUMizerPatient.plogs)(_starter._plogs1 /*Object*/ );
 //BA.debugLineNum = 175;BA.debugLine="p_Log.Visible=True";
...
b4a.OPTUMizerPatient.pmedication _p_medication = null;
 //BA.debugLineNum = 151;BA.debugLine="Sub btnMedications_click()";
 //BA.debugLineNum = 152;BA.debugLine="Dim p_Medication As PMedication";
_p_medication = new b4a.OPTUMizerPatient.pmedication();
 //BA.debugLineNum = 153;BA.debugLine="p_Medication=Starter.PMedication1";
_p_medication = (b4a.OPTUMizerPatient.pmedication)(_starter._pmedication1 /*Object*/ );
 //BA.debugLineNum = 154;BA.debugLine="p_Medication.Visible=True";
_p_medication._setvisible /*boolean*/ (__c.True);
 //BA.debugLineNum = 155;BA.debugLine="setVisible(False)";
_setvisible(__c.False);
...
b4a.OPTUMizerPatient.pprofile _profile = null;
 //BA.debugLineNum = 131;BA.debugLine="Sub btnProfile_click()";
 //BA.debugLineNum = 132;BA.debugLine="Dim profile As PProfile";
_profile = new b4a.OPTUMizerPatient.pprofile();
 //BA.debugLineNum = 133;BA.debugLine="profile=Starter.PProfile1";
_profile = (b4a.OPTUMizerPatient.pprofile)(_starter._pprofile1 /*Object*/ );
 //BA.debugLineNum = 134;BA.debugLine="profile.Visible=True";
...
b4a.OPTUMizerPatient.pqr _qrcode = null;
 //BA.debugLineNum = 137;BA.debugLine="Sub btnQr_click()";
 //BA.debugLineNum = 138;BA.debugLine="Dim qrCode As PQr";
_qrcode = new b4a.OPTUMizerPatient.pqr();
 //BA.debugLineNum = 139;BA.debugLine="qrCode=Starter.PQr1";
_qrcode = (b4a.OPTUMizerPatient.pqr)(_starter._pqr1 /*Object*/ );
 //BA.debugLineNum = 140;BA.debugLine="qrCode.Visible=True";
...
b4a.OPTUMizerPatient.pschedule _p_schedule = null;
 //BA.debugLineNum = 143;BA.debugLine="Sub btnSchedule_click()";
 //BA.debugLineNum = 144;BA.debugLine="Dim p_Schedule As PSchedule";
_p_schedule = new b4a.OPTUMizerPatient.pschedule();
 //BA.debugLineNum = 145;BA.debugLine="p_Schedule=Starter.PSchedule1";
_p_schedule = (b4a.OPTUMizerPatient.pschedule)(_starter._pschedule1 /*Object*/ );
 //BA.debugLineNum = 146;BA.debugLine="p_Schedule.Visible=True";
...
b4a.OPTUMizerPatient.pupdates _p_update = null;
 //BA.debugLineNum = 166;BA.debugLine="Sub btnUpdates_click()";
 //BA.debugLineNum = 167;BA.debugLine="Dim p_Update As PUpdates";
_p_update = new b4a.OPTUMizerPatient.pupdates();
 //BA.debugLineNum = 168;BA.debugLine="p_Update=Starter.PUpdates1";
_p_update = (b4a.OPTUMizerPatient.pupdates)(_starter._pupdates1 /*Object*/ );
 //BA.debugLineNum = 169;BA.debugLine="p_Update.Visible=True";
...
public String  _btnupload_click() throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Sub btnUpload_click()";
...
public String  _frame_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub Frame_click()";
 //BA.debugLineNum = 204;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.PanelWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Public Sub GetBase As Panel";
 //BA.debugLineNum = 222;BA.debugLine="Return mBase";
if (true) return _mbase;
 //BA.debugLineNum = 223;BA.debugLine="End Sub";
return null;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Public Sub getVisible() As Boolean";
...
public String  _gtkforms() throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Public Sub GTKForms";
 //BA.debugLineNum = 98;BA.debugLine="mBase.Color=0x000000'transparent background";
_mbase.setColor((int) (0x000000));
 //BA.debugLineNum = 99;BA.debugLine="mBase.Width=100%x";
_mbase.setWidth(__c.PerXToCurrent((float) (100),ba));
 //BA.debugLineNum = 100;BA.debugLine="mBase.height=100%y";
_mbase.setHeight(__c.PerYToCurrent((float) (100),ba));
 //BA.debugLineNum = 101;BA.debugLine="mBase.AddView(Image1,0.00 * mBase.Width,0.00 * mB";
_mbase.AddView((android.view.View)(_image1.getObject()),(int) (0.00*_mbase.getWidth()),(int) (0.00*_mbase.getHeight()),(int) (1.00*_mbase.getWidth()),(int) (1.00*_mbase.getHeight()));
 //BA.debugLineNum = 102;BA.debugLine="Image1.Bitmap = LoadBitmapResize(File.DirAssets,\"";
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"HomeModule-809c8.png",_image1.getWidth(),_image1.getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 103;BA.debugLine="mBase.AddView(btnProfile,0.05 * mBase.Width,0.01";
_mbase.AddView((android.view.View)(_btnprofile.getObject()),(int) (0.05*_mbase.getWidth()),(int) (0.01*_mbase.getHeight()),(int) (0.14*_mbase.getWidth()),(int) (0.07*_mbase.getHeight()));
 //BA.debugLineNum = 104;BA.debugLine="mBase.AddView(btnQr,0.83 * mBase.Width,0.01 * mBa";
_mbase.AddView((android.view.View)(_btnqr.getObject()),(int) (0.83*_mbase.getWidth()),(int) (0.01*_mbase.getHeight()),(int) (0.14*_mbase.getWidth()),(int) (0.07*_mbase.getHeight()));
 //BA.debugLineNum = 105;BA.debugLine="mBase.AddView(btnSchedule,0.52 * mBase.Width,0.19";
_mbase.AddView((android.view.View)(_btnschedule.getObject()),(int) (0.52*_mbase.getWidth()),(int) (0.19*_mbase.getHeight()),(int) (0.42*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 106;BA.debugLine="mBase.AddView(btnUpload,0.80 * mBase.Width,0.30 *";
_mbase.AddView((android.view.View)(_btnupload.getObject()),(int) (0.80*_mbase.getWidth()),(int) (0.30*_mbase.getHeight()),(int) (0.11*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 107;BA.debugLine="mBase.AddView(btnMedications,0.07 * mBase.Width,0";
_mbase.AddView((android.view.View)(_btnmedications.getObject()),(int) (0.07*_mbase.getWidth()),(int) (0.42*_mbase.getHeight()),(int) (0.25*_mbase.getWidth()),(int) (0.11*_mbase.getHeight()));
 //BA.debugLineNum = 108;BA.debugLine="mBase.AddView(btnAppointments,0.38 * mBase.Width,";
_mbase.AddView((android.view.View)(_btnappointments.getObject()),(int) (0.38*_mbase.getWidth()),(int) (0.42*_mbase.getHeight()),(int) (0.26*_mbase.getWidth()),(int) (0.11*_mbase.getHeight()));
 //BA.debugLineNum = 109;BA.debugLine="mBase.AddView(btnHotline,0.69 * mBase.Width,0.42";
_mbase.AddView((android.view.View)(_btnhotline.getObject()),(int) (0.69*_mbase.getWidth()),(int) (0.42*_mbase.getHeight()),(int) (0.25*_mbase.getWidth()),(int) (0.11*_mbase.getHeight()));
 //BA.debugLineNum = 110;BA.debugLine="mBase.AddView(btnUpdates,0.41 * mBase.Width,0.93";
_mbase.AddView((android.view.View)(_btnupdates.getObject()),(int) (0.41*_mbase.getWidth()),(int) (0.93*_mbase.getHeight()),(int) (0.22*_mbase.getWidth()),(int) (0.07*_mbase.getHeight()));
 //BA.debugLineNum = 111;BA.debugLine="mBase.AddView(btnLogs,0.78 * mBase.Width,0.93 * m";
_mbase.AddView((android.view.View)(_btnlogs.getObject()),(int) (0.78*_mbase.getWidth()),(int) (0.93*_mbase.getHeight()),(int) (0.22*_mbase.getWidth()),(int) (0.07*_mbase.getHeight()));
 //BA.debugLineNum = 112;BA.debugLine="mBase.AddView(lblName,0.05 * mBase.Width,0.10 * m";
_mbase.AddView((android.view.View)(_lblname.getObject()),(int) (0.05*_mbase.getWidth()),(int) (0.10*_mbase.getHeight()),(int) (0.90*_mbase.getWidth()),(int) (0.09*_mbase.getHeight()));
 //BA.debugLineNum = 113;BA.debugLine="mBase.AddView(lblProgress,0.09 * mBase.Width,0.30";
_mbase.AddView((android.view.View)(_lblprogress.getObject()),(int) (0.09*_mbase.getWidth()),(int) (0.30*_mbase.getHeight()),(int) (0.68*_mbase.getWidth()),(int) (0.04*_mbase.getHeight()));
 //BA.debugLineNum = 114;BA.debugLine="mBase.AddView(progressBar,0.09 * mBase.Width,0.37";
_mbase.AddView((android.view.View)(_progressbar.getObject()),(int) (0.09*_mbase.getWidth()),(int) (0.37*_mbase.getHeight()),(int) (0.83*_mbase.getWidth()),(int) (0.03*_mbase.getHeight()));
 //BA.debugLineNum = 115;BA.debugLine="mBase.AddView(ProgressPercent,0.09 * mBase.Width,";
_mbase.AddView((android.view.View)(_progresspercent.getObject()),(int) (0.09*_mbase.getWidth()),(int) (0.34*_mbase.getHeight()),(int) (0.16*_mbase.getWidth()),(int) (0.04*_mbase.getHeight()));
 //BA.debugLineNum = 122;BA.debugLine="initPHome";
_initphome();
 //BA.debugLineNum = 124;BA.debugLine="End Sub";
return "";
}
public String  _image1_click() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Sub Image1_click()";
...
_btnupload.Initialize(ba,"btnUpload");
 //BA.debugLineNum = 47;BA.debugLine="btnAppointments.Initialize(\"btnAppointments\")";
_btnappointments.Initialize(ba,"btnAppointments");
 //BA.debugLineNum = 48;BA.debugLine="btnHotline.Initialize(\"btnHotline\")";
_btnhotline.Initialize(ba,"btnHotline");
 //BA.debugLineNum = 49;BA.debugLine="btnUpdates.Initialize(\"btnUpdates\")";
_btnupdates.Initialize(ba,"btnUpdates");
 //BA.debugLineNum = 50;BA.debugLine="btnLogs.Initialize(\"btnLogs\")";
_btnlogs.Initialize(ba,"btnLogs");
 //BA.debugLineNum = 51;BA.debugLine="lblName.Initialize(\"lblName\")";
_lblname.Initialize(ba,"lblName");
 //BA.debugLineNum = 52;BA.debugLine="lblProgress.Initialize(\"lblProgress\")";
_lblprogress.Initialize(ba,"lblProgress");
 //BA.debugLineNum = 53;BA.debugLine="progressBar.Initialize(\"progressBar\")";
_progressbar.Initialize(ba,"progressBar");
 //BA.debugLineNum = 54;BA.debugLine="ProgressPercent.Initialize(\"ProgressPercent\")";
_progresspercent.Initialize(ba,"ProgressPercent");
 //BA.debugLineNum = 55;BA.debugLine="btnMedications.Initialize(\"btnMedications\")";
...
_progressbar.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 90;BA.debugLine="ProgressPercent.Color =  0x00ffffff";
_progresspercent.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 91;BA.debugLine="ProgressPercent.TextColor = 0xff000000";
_progresspercent.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 92;BA.debugLine="ProgressPercent.Gravity = Gravity.CENTER_HORIZONT";
_progresspercent.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 93;BA.debugLine="ProgressPercent.Text = \"\"";
_progresspercent.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 96;BA.debugLine="End Sub";
return "";
}
public String  _lblname_click() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub lblName_click()";
 //BA.debugLineNum = 181;BA.debugLine="End Sub";
return "";
}
public String  _lblprogress_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub lblProgress_click()";
 //BA.debugLineNum = 184;BA.debugLine="End Sub";
return "";
}
public String  _pdoclist_cellclick(int _col,int _row) throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub pDocList_CellClick (Col As Int, Row As Int)";
 //BA.debugLineNum = 209;BA.debugLine="End Sub";
return "";
}
public String  _pdoclist_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub pDocList_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 187;BA.debugLine="End Sub";
return "";
}
public String  _photline_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Sub pHotline_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 202;BA.debugLine="End Sub";
return "";
}
public String  _progressbar_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub progressBar_click()";
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return "";
}
public String  _progresspercent_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub ProgressPercent_click()";
 //BA.debugLineNum = 199;BA.debugLine="End Sub";
return "";
}
public String  _setlayout(int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Public Sub SetLayout(Left As Int,Top As Int,Width";
 //BA.debugLineNum = 218;BA.debugLine="mBase.SetLayout(Left,Top,Width,Height )";
_mbase.SetLayout(_left,_top,_width,_height);
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _flag) throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Public Sub setVisible(flag As Boolean)";
 //BA.debugLineNum = 215;BA.debugLine="mBase.Visible=flag";
