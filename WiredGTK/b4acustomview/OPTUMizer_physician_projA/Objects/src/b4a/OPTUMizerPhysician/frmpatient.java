...
public class frmpatient extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPhysician.frmpatient");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPhysician.frmpatient.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.objects.PanelWrapper _btnsignin = null;
...
public String  _btnsignin_click() throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub btnSignIn_click()";
...
_image1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim btnSignIn As Panel";
_btnsignin = new anywheresoftware.b4a.objects.PanelWrapper();
...
public anywheresoftware.b4a.objects.PanelWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Public Sub GetBase As Panel";
...
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Public Sub getVisible() As Boolean";
 //BA.debugLineNum = 67;BA.debugLine="Return mBase.Visible";
...
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"LoginModule-bf106.png",_image1.getWidth(),_image1.getHeight(),__c.True).getObject()));
 //BA.debugLineNum = 47;BA.debugLine="mBase.AddView(btnSignIn,0.15 * mBase.Width,0.76 *";
_mbase.AddView((android.view.View)(_btnsignin.getObject()),(int) (0.15*_mbase.getWidth()),(int) (0.76*_mbase.getHeight()),(int) (0.72*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 48;BA.debugLine="btnSignIn.Color =  0xff007160";
_btnsignin.setColor((int) (0xff007160));
 //BA.debugLineNum = 49;BA.debugLine="mBase.AddView(txtID,0.15 * mBase.Width,0.58 * mBa";
_mbase.AddView((android.view.View)(_txtid.getObject()),(int) (0.15*_mbase.getWidth()),(int) (0.58*_mbase.getHeight()),(int) (0.70*_mbase.getWidth()),(int) (0.08*_mbase.getHeight()));
 //BA.debugLineNum = 50;BA.debugLine="mBase.AddView(txtPassword,0.15 * mBase.Width,0.67";
_mbase.AddView((android.view.View)(_txtpassword.getObject()),(int) (0.15*_mbase.getWidth()),(int) (0.67*_mbase.getHeight()),(int) (0.70*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return "";
}
public String  _image1_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub Image1_click()";
...
_image1.Initialize(ba,"Image1");
 //BA.debugLineNum = 31;BA.debugLine="btnSignIn.Initialize(\"btnSignIn\")";
_btnsignin.Initialize(ba,"btnSignIn");
...
public String  _setlayout(int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Public Sub SetLayout(Left As Int,Top As Int,Width";
 //BA.debugLineNum = 73;BA.debugLine="mBase.SetLayout(Left,Top,Width,Height )";
_mbase.SetLayout(_left,_top,_width,_height);
 //BA.debugLineNum = 74;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _flag) throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Public Sub setVisible(flag As Boolean)";
 //BA.debugLineNum = 70;BA.debugLine="mBase.Visible=flag";
_mbase.setVisible(_flag);
 //BA.debugLineNum = 71;BA.debugLine="End Sub";
return "";
}
public String  _txtid_click() throws Exception{
 //BA.debugLineNum = 61;BA.debugLine="Sub txtID_click()";
 //BA.debugLineNum = 62;BA.debugLine="End Sub";
return "";
}
public String  _txtpassword_click() throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub txtPassword_click()";
