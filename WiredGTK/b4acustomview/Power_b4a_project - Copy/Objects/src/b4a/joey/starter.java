...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.joey", "b4a.joey.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.joey.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static b4a.joey.wtaserver _wsh = null;
public static b4a.joey.clsparser _myparser = null;
public static b4a.joey.clsparser _parse1 = null;
public static b4a.joey.clsparser _volt = null;
public static b4a.joey.clsparser _amp = null;
public static b4a.joey.clsparser _powerwatt = null;
public static b4a.joey.clsparser _energy = null;
...
public static Object _frmsplash1 = null;
public static Object _frmpatient1 = null;
...
String _z = "";
 //BA.debugLineNum = 111;BA.debugLine="Sub astream_NewData (Buffer() As Byte)";
 //BA.debugLineNum = 112;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 113;BA.debugLine="str=BytesToString(Buffer, 0, Buffer.Length, \"UTF8";
...
_aa = 0;
 //BA.debugLineNum = 116;BA.debugLine="Dim x As frmcontrols";
_x = new b4a.joey.frmcontrols();
 //BA.debugLineNum = 117;BA.debugLine="x=frmcontrols1";
_x = (b4a.joey.frmcontrols)(_frmcontrols1);
 //BA.debugLineNum = 118;BA.debugLine="For aa = 0 To str.Length-1";
{
final int step6 = 1;
final int limit6 = (int) (_str.length()-1);
_aa = (int) (0) ;
for (;_aa <= limit6 ;_aa = _aa + step6 ) {
 //BA.debugLineNum = 119;BA.debugLine="Dim z As String";
_z = "";
 //BA.debugLineNum = 120;BA.debugLine="z=str.SubString2(aa,aa+1)";
_z = _str.substring(_aa,(int) (_aa+1));
 //BA.debugLineNum = 122;BA.debugLine="If myparser.available(z)=True Then";
if (_myparser._available /*boolean*/ (_z)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 123;BA.debugLine="Dim x As frmcontrols";
_x = new b4a.joey.frmcontrols();
 //BA.debugLineNum = 124;BA.debugLine="x=frmcontrols1";
_x = (b4a.joey.frmcontrols)(_frmcontrols1);
 //BA.debugLineNum = 125;BA.debugLine="x.detected.objectdetected(myparser.data)";
_x._detected /*b4a.joey.objdetect*/ ._objectdetected /*int*/ (_myparser._data /*String*/ );
 };
 }
};
...
public static String  _conns(int _res,anywheresoftware.b4a.objects.collections.Map _paireddevices,anywheresoftware.b4a.objects.collections.List _l) throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Sub conns(res As Int, PairedDevices As Map, L As L";
 //BA.debugLineNum = 83;BA.debugLine="Serial1.Connect3(PairedDevices.Get(L.Get(res)),1)";
...
float _lon = 0f;
String _speed = "";
 //BA.debugLineNum = 229;BA.debugLine="Sub GPS_LocationChanged (Location1 As Location)";
 //BA.debugLineNum = 230;BA.debugLine="Dim lat As Float= NumberFormat(Location1.Latitude";
_lat = (float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_location1.getLatitude(),(int) (1),(int) (6))));
 //BA.debugLineNum = 231;BA.debugLine="Dim lon As Float= NumberFormat(Location1.Longitud";
_lon = (float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_location1.getLongitude(),(int) (1),(int) (6))));
 //BA.debugLineNum = 232;BA.debugLine="Dim speed As String = \"Speed = \" & Location1.Spee";
_speed = "Speed = "+BA.NumberToString(_location1.getSpeed());
 //BA.debugLineNum = 233;BA.debugLine="If wsh.connected=True Then";
if (_wsh._connected /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 234;BA.debugLine="wsh.SendClient(\"WTAGPS\" & lat & \",\" & lon & \",\"";
...
int _i = 0;
int _res = 0;
b4a.joey.bluetooth _bluetooth = null;
 //BA.debugLineNum = 165;BA.debugLine="Sub mnuConnect_Click";
 //BA.debugLineNum = 166;BA.debugLine="Dim PairedDevices As Map";
_paireddevices = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 167;BA.debugLine="If connected_BT=False Then";
if (_connected_bt==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 168;BA.debugLine="PairedDevices = Serial1.GetPairedDevices";
_paireddevices = _serial1.GetPairedDevices();
 //BA.debugLineNum = 169;BA.debugLine="Dim L As List";
_l = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 170;BA.debugLine="L.Initialize";
_l.Initialize();
 //BA.debugLineNum = 171;BA.debugLine="For i = 0 To PairedDevices.Size - 1";
{
final int step6 = 1;
final int limit6 = (int) (_paireddevices.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit6 ;_i = _i + step6 ) {
 //BA.debugLineNum = 172;BA.debugLine="L.Add(PairedDevices.GetKeyAt(i)) 'add the frien";
_l.Add(_paireddevices.GetKeyAt(_i));
 }
};
 //BA.debugLineNum = 174;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 175;BA.debugLine="Dim bluetooth As bluetooth=bluetoothview1";
_bluetooth = (b4a.joey.bluetooth)(_bluetoothview1);
 //BA.debugLineNum = 176;BA.debugLine="res=CallSub2(bluetooth,\"Getlist\",L)";
_res = (int)(BA.ObjectToNumber(anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(_bluetooth),"Getlist",(Object)(_l))));
 //BA.debugLineNum = 178;BA.debugLine="If res <> DialogResponse.CANCEL Then";
if (_res!=anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 181;BA.debugLine="Serial1.Connect3(PairedDevices.Get(L.Get(res))";
_serial1.Connect3(processBA,BA.ObjectToString(_paireddevices.Get(_l.Get(_res))),(int) (1));
 };
 };
...
public static String  _mnudisconnect_click() throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Sub mnuDisconnect_Click";
 //BA.debugLineNum = 75;BA.debugLine="If connected_BT=True Then";
...
_serial1.Disconnect();
 //BA.debugLineNum = 79;BA.debugLine="connected_BT=False";
...
public static String  _msec(int _xa) throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Sub msec(xa As Int)";
 //BA.debugLineNum = 208;BA.debugLine="msec_ = xa";
_msec_ = _xa;
 //BA.debugLineNum = 209;BA.debugLine="Do While(msec_<>0)";
while ((_msec_!=0)) {
 //BA.debugLineNum = 210;BA.debugLine="DoEvents";
...
String _x = "";
 //BA.debugLineNum = 199;BA.debugLine="public Sub Println(str As String)";
 //BA.debugLineNum = 200;BA.debugLine="Dim x As String";
_x = "";
 //BA.debugLineNum = 201;BA.debugLine="str=str&Chr(13)";
_str = _str+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 202;BA.debugLine="x=str.Length";
_x = BA.NumberToString(_str.length());
 //BA.debugLineNum = 203;BA.debugLine="If connected_BT=True Then";
if (_connected_bt==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 204;BA.debugLine="astream.Write(str.GetBytes(\"UTF8\"))";
...
_rp = new anywheresoftware.b4a.objects.RuntimePermissions();
 //BA.debugLineNum = 37;BA.debugLine="Dim frmsplash1 As Object";
_frmsplash1 = new Object();
 //BA.debugLineNum = 38;BA.debugLine="dim frmpatient1 as Object'''";
_frmpatient1 = new Object();
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return "";
}
public static String  _serial1_connected(boolean _success) throws Exception{
b4a.joey.bluetooth _bluetooth = null;
 //BA.debugLineNum = 86;BA.debugLine="Sub Serial1_Connected (Success As Boolean)";
 //BA.debugLineNum = 87;BA.debugLine="Dim bluetooth As bluetooth=bluetoothview1";
_bluetooth = (b4a.joey.bluetooth)(_bluetoothview1);
 //BA.debugLineNum = 88;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 89;BA.debugLine="ToastMessageShow(\"Connected successfully\", False";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Connected successfully"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 94;BA.debugLine="astream.Initialize(Serial1.InputStream, Serial1.";
_astream.Initialize(processBA,_serial1.getInputStream(),_serial1.getOutputStream(),"astream");
 //BA.debugLineNum = 95;BA.debugLine="connected_BT = True";
_connected_bt = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 98;BA.debugLine="bluetooth.Label2.Text=\"Connected\"";
_bluetooth._label2 /*anywheresoftware.b4a.objects.LabelWrapper*/ .setText(BA.ObjectToCharSequence("Connected"));
 }else {
 //BA.debugLineNum = 101;BA.debugLine="connected_BT = False";
_connected_bt = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 102;BA.debugLine="ToastMessageShow(\"Check BT connection\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Check BT connection"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 104;BA.debugLine="bluetooth.Label2.Text=\"DisConnected\"";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="timer1.Initialize(\"Timer1\",1000*60)'one minute";
_timer1.Initialize(processBA,"Timer1",(long) (1000*60));
 //BA.debugLineNum = 47;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 48;BA.debugLine="sms_rx.Initialize(\"sms_rx\")";
_sms_rx.Initialize("sms_rx",processBA);
 //BA.debugLineNum = 49;BA.debugLine="Serial1.Initialize(\"Serial1\")";
_serial1.Initialize("Serial1");
 //BA.debugLineNum = 51;BA.debugLine="customview.Initialize";
_customview.Initialize();
 //BA.debugLineNum = 55;BA.debugLine="myparser.Initialize(\"WTA\",Chr(13),1)";
_myparser._initialize /*String*/ (processBA,"WTA",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13))),(int) (1));
 //BA.debugLineNum = 56;BA.debugLine="volt.Initialize(\"Volt RMS: \",\"A\",1)";
_volt._initialize /*String*/ (processBA,"Volt RMS: ","A",(int) (1));
 //BA.debugLineNum = 57;BA.debugLine="energy.Initialize(\"Watt-Hour: \",\"I\",1)";
_energy._initialize /*String*/ (processBA,"Watt-Hour: ","I",(int) (1));
 //BA.debugLineNum = 58;BA.debugLine="amp.Initialize(\"Amp RMS: \",\"R\",1)";
_amp._initialize /*String*/ (processBA,"Amp RMS: ","R",(int) (1));
 //BA.debugLineNum = 59;BA.debugLine="powerWatt.Initialize(\"Real Power: \",\"V\",1)";
_powerwatt._initialize /*String*/ (processBA,"Real Power: ","V",(int) (1));
 //BA.debugLineNum = 60;BA.debugLine="parse1.Initialize(\"GETVAL$\",\"#\",1)";
_parse1._initialize /*String*/ (processBA,"GETVAL$","#",(int) (1));
 //BA.debugLineNum = 62;BA.debugLine="End Sub";
return "";
}
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 226;BA.debugLine="ToastMessageShow(\"exit\",True)";
...
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public static String  _service_taskremoved() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Sub Service_TaskRemoved";
...
int _aa = 0;
String _z = "";
 //BA.debugLineNum = 151;BA.debugLine="Sub sms_rx_MessageReceived(From As String, Body As";
 //BA.debugLineNum = 152;BA.debugLine="Dim strsend As String";
_strsend = "";
 //BA.debugLineNum = 153;BA.debugLine="If Body=\"Hello\" Then";
if ((_body).equals("Hello")) { 
 //BA.debugLineNum = 154;BA.debugLine="sms.Send(From,\"what the hell\")";
_sms.Send(_from,"what the hell");
 };
 //BA.debugLineNum = 156;BA.debugLine="Dim aa As Int";
_aa = 0;
 //BA.debugLineNum = 157;BA.debugLine="For aa = 0 To Body.Length-1";
{
final int step6 = 1;
final int limit6 = (int) (_body.length()-1);
_aa = (int) (0) ;
for (;_aa <= limit6 ;_aa = _aa + step6 ) {
 //BA.debugLineNum = 158;BA.debugLine="Dim z As String";
_z = "";
 //BA.debugLineNum = 159;BA.debugLine="z=Body.SubString2(aa,aa+1)";
_z = _body.substring(_aa,(int) (_aa+1));
 //BA.debugLineNum = 160;BA.debugLine="If myparser.available(z)=True Then";
if (_myparser._available /*boolean*/ (_z)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 161;BA.debugLine="ToastMessageShow(myparser.data,False)";
...
String _strs = "";
 //BA.debugLineNum = 188;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 189;BA.debugLine="ToastMessageShow(\"saving logs to power_log.csv\",T";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("saving logs to power_log.csv"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 191;BA.debugLine="If File.Exists(File.DirRootExternal, \"power_log.c";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"power_log.csv")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 192;BA.debugLine="Dim strs As String=vb6.GetFileStr(\"power_log.csv";
_strs = mostCurrent._vb6._getfilestr /*String*/ (processBA,"power_log.csv");
 //BA.debugLineNum = 193;BA.debugLine="strs=strs&voltx&\",\"&ampx&\",\"&powerWattx&\",\"&ener";
_strs = _strs+_voltx+","+_ampx+","+_powerwattx+","+_energyx+","+mostCurrent._vb6._now /*String*/ (processBA)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 194;BA.debugLine="vb6.SaveFileStr(\"power_log.csv\",strs)";
mostCurrent._vb6._savefilestr /*String*/ (processBA,"power_log.csv",_strs);
 }else {
 //BA.debugLineNum = 196;BA.debugLine="vb6.SaveFileStr(\"power_log.csv\",\"Volt,Current,Po";
...
int _aa = 0;
String _z = "";
 //BA.debugLineNum = 63;BA.debugLine="Sub wsh_NewData(data As String)";
 //BA.debugLineNum = 64;BA.debugLine="ToastMessageShow(data,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_data),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 65;BA.debugLine="Dim aa As Int";
_aa = 0;
 //BA.debugLineNum = 66;BA.debugLine="For aa = 0 To data.Length-1";
{
final int step3 = 1;
final int limit3 = (int) (_data.length()-1);
_aa = (int) (0) ;
for (;_aa <= limit3 ;_aa = _aa + step3 ) {
 //BA.debugLineNum = 67;BA.debugLine="Dim z As String";
_z = "";
 //BA.debugLineNum = 68;BA.debugLine="z=data.SubString2(aa,aa+1)";
_z = _data.substring(_aa,(int) (_aa+1));
 //BA.debugLineNum = 69;BA.debugLine="If parse1.available(z)=True Then";
if (_parse1._available /*boolean*/ (_z)==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 70;BA.debugLine="ToastMessageShow(parse1.data,False)";
