...
anywheresoftware.b4a.keywords.Common.LogImpl("721233677",BA.ObjectToString((anywheresoftware.b4a.keywords.Common.GetType((Object)(""))).equals("java.lang.Integer")),0);
 //BA.debugLineNum = 126;BA.debugLine="Log(\"Key: \" & am.GetKeyAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("721233678","Key: "+BA.ObjectToString(_am.GetKeyAt(_i)),0);
 //BA.debugLineNum = 127;BA.debugLine="Log(\"Value: \" & am.GetValueAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("721233679","Value: "+BA.ObjectToString(_am.GetValueAt(_i)),0);
 }
};
