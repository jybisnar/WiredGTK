...
public class table extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPhysician.table");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPhysician.table.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("318612226","Wrong number of values.",0);
...
_rc = (b4a.OPTUMizerPhysician.table._rowcol)(_l.getTag());
...
_rc = (b4a.OPTUMizerPhysician.table._rowcol)(_lbls[_i].getTag());
...
__c.LogImpl("318808837","HideRow: (null) "+BA.NumberToString(_row),0);
