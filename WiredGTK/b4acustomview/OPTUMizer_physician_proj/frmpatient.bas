...
Public Sub Initialize (Callback As Object, EventName As String)
	...
	btnSignIn.Initialize("btnSignIn")
...
Public Sub GTKForms
	...
	mBase.AddView(btnSignIn,0.15 * mBase.Width,0.76 * mBase.Height,0.72 * mBase.Width,0.05 * mBase.Height)
	btnSignIn.Color =  0xff007160
	mBase.AddView(txtID,0.15 * mBase.Width,0.58 * mBase.Height,0.70 * mBase.Width,0.08 * mBase.Height)
	mBase.AddView(txtPassword,0.15 * mBase.Width,0.67 * mBase.Height,0.70 * mBase.Width,0.06 * mBase.Height)
