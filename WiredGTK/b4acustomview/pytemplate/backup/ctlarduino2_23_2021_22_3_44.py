...
class Handler(usercontrol):
	...
	def GTKForms(self):
		...
		self.create("{'Name': 'Button2', 'Text': 'Button2', 'Top': '180', 'Left': '135', 'Width': '100', 'Height': '50', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[]")
	def Widget(self):
