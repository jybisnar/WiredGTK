...
public b4a.OPTUMizerPatient.bluetooth _bluetooth1 = null;
public b4a.OPTUMizerPatient.frmsplash _frmsplash1 = null;
public b4a.OPTUMizerPatient.frmcontrols _frmcontrols1 = null;
...
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 46;BA.debugLine="bluetooth1.SetLayout(0,0,100%x,100%y)";
mostCurrent._bluetooth1._setlayout /*String*/ ((int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 47;BA.debugLine="frmcontrols1.SetLayout(0,0,100%x,100%y)";
mostCurrent._frmcontrols1._setlayout /*String*/ ((int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 48;BA.debugLine="bluetooth1.Visible=False";
mostCurrent._bluetooth1._setvisible /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 49;BA.debugLine="frmcontrols1.Visible=False";
mostCurrent._frmcontrols1._setvisible /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 50;BA.debugLine="frmsplash1.SetLayout(0,0,100%x,100%y)";
mostCurrent._frmsplash1._setlayout /*String*/ ((int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 51;BA.debugLine="frmsplash1.Visible=False";
...
//C
this.state = 1;
 //BA.debugLineNum = 91;BA.debugLine="Starter.frmcontrols1=frmcontrols1";
...
if (mostCurrent._starter._connected_bt /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 84;BA.debugLine="bluetooth1.imgconnect_click";
...
public static String  _done_click() throws Exception{
 ...
 //BA.debugLineNum = 79;BA.debugLine="frmsplash1.Visible=True";
mostCurrent._frmsplash1._setvisible /*boolean*/ (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 80;BA.debugLine="frmcontrols1.Visible=False";
mostCurrent._frmcontrols1._setvisible /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="Private bluetooth1 As bluetooth";
mostCurrent._bluetooth1 = new b4a.OPTUMizerPatient.bluetooth();
 //BA.debugLineNum = 23;BA.debugLine="Private frmsplash1 As frmsplash";
mostCurrent._frmsplash1 = new b4a.OPTUMizerPatient.frmsplash();
 //BA.debugLineNum = 24;BA.debugLine="Private frmcontrols1 As frmcontrols";
mostCurrent._frmcontrols1 = new b4a.OPTUMizerPatient.frmcontrols();
...
public static String  _refresh_click() throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="frmsplash1.Visible=False";
mostCurrent._frmsplash1._setvisible /*boolean*/ (anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 76;BA.debugLine="frmcontrols1.Visible=True";
