...
public String  _addtoparent(anywheresoftware.b4a.objects.ActivityWrapper _parent,int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 24;BA.debugLine="Public Sub AddToParent(Parent As Activity, Left As";
 //BA.debugLineNum = 25;BA.debugLine="mBase.Initialize(\"mBase\")";
_mbase.Initialize(ba,"mBase");
 //BA.debugLineNum = 26;BA.debugLine="Parent.AddView(mBase, Left, Top, Width, Height)";
_parent.AddView((android.view.View)(_mbase.getObject()),_left,_top,_width,_height);
 //BA.debugLineNum = 27;BA.debugLine="GTKForms";
_gtkforms();
...
b4a.OPTUMizerPatient.phome _home = null;
 //BA.debugLineNum = 80;BA.debugLine="Sub btnLogIn_click()";
 //BA.debugLineNum = 81;BA.debugLine="Dim home As PHome";
_home = new b4a.OPTUMizerPatient.phome();
 //BA.debugLineNum = 82;BA.debugLine="home=Starter.PHome1";
_home = (b4a.OPTUMizerPatient.phome)(_starter._phome1 /*Object*/ );
 //BA.debugLineNum = 83;BA.debugLine="home.Visible=True";
_home._setvisible /*boolean*/ (__c.True);
 //BA.debugLineNum = 85;BA.debugLine="setVisible(False)";
...
public String  _designercreateview(anywheresoftware.b4a.objects.PanelWrapper _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Public Sub DesignerCreateView (Base As Panel, Lbl";
 //BA.debugLineNum = 43;BA.debugLine="mBase = Base";
_mbase = _base;
 //BA.debugLineNum = 44;BA.debugLine="GTKForms";
_gtkforms();
...
_mbase.setHeight(__c.PerYToCurrent((float) (100),ba));
 //BA.debugLineNum = 64;BA.debugLine="mBase.AddView(Image1,0.00 * mBase.Width,0.00 * mB";
_mbase.AddView((android.view.View)(_image1.getObject()),(int) (0.00*_mbase.getWidth()),(int) (0.00*_mbase.getHeight()),(int) (1.01*_mbase.getWidth()),(int) (1.00*_mbase.getHeight()));
 //BA.debugLineNum = 65;BA.debugLine="Image1.Bitmap = LoadBitmapResize(File.DirAssets,\"";
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"LoginModule-bf106.png",_image1.getWidth(),_image1.getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 66;BA.debugLine="mBase.AddView(btnLogIn,0.12 * mBase.Width,0.80 *";
_mbase.AddView((android.view.View)(_btnlogin.getObject()),(int) (0.12*_mbase.getWidth()),(int) (0.80*_mbase.getHeight()),(int) (0.76*_mbase.getWidth()),(int) (0.05*_mbase.getHeight()));
 //BA.debugLineNum = 67;BA.debugLine="mBase.AddView(txtID,0.14 * mBase.Width,0.70 * mBa";
_mbase.AddView((android.view.View)(_txtid.getObject()),(int) (0.14*_mbase.getWidth()),(int) (0.70*_mbase.getHeight()),(int) (0.75*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 68;BA.debugLine="mBase.AddView(txtPassword,0.14 * mBase.Width,0.70";
_mbase.AddView((android.view.View)(_txtpassword.getObject()),(int) (0.14*_mbase.getWidth()),(int) (0.70*_mbase.getHeight()),(int) (0.75*_mbase.getWidth()),(int) (0.06*_mbase.getHeight()));
 //BA.debugLineNum = 70;BA.debugLine="initPLogin";
_initplogin();
 //BA.debugLineNum = 73;BA.debugLine="End Sub";
return "";
}
public String  _image1_click() throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Sub Image1_click()";
...
_image1.Initialize(ba,"Image1");
 //BA.debugLineNum = 33;BA.debugLine="btnLogIn.Initialize(\"btnLogIn\")";
_btnlogin.Initialize(ba,"btnLogIn");
 //BA.debugLineNum = 34;BA.debugLine="txtID.Initialize(\"txtID\")";
_txtid.Initialize(ba,"txtID");
 //BA.debugLineNum = 35;BA.debugLine="txtPassword.Initialize(\"txtPassword\")";
_txtpassword.Initialize(ba,"txtPassword");
 //BA.debugLineNum = 40;BA.debugLine="End Sub";
return "";
}
public String  _initplogin() throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub initPLogin";
 //BA.debugLineNum = 49;BA.debugLine="btnLogIn.Color =  0x00001f59";
_btnlogin.setColor((int) (0x00001f59));
 //BA.debugLineNum = 50;BA.debugLine="txtID.Gravity = Gravity.CENTER_HORIZONTAL+Gravity";
_txtid.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 51;BA.debugLine="txtID.Color =  0x00ffffff";
_txtid.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 52;BA.debugLine="txtID.TextColor = 0xff000000";
_txtid.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 53;BA.debugLine="txtID.Text = \"\"";
_txtid.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 54;BA.debugLine="txtPassword.Gravity = Gravity.CENTER_HORIZONTAL+G";
_txtpassword.setGravity((int) (__c.Gravity.CENTER_HORIZONTAL+__c.Gravity.CENTER_VERTICAL));
 //BA.debugLineNum = 55;BA.debugLine="txtPassword.Color =  0x00ffffff";
_txtpassword.setColor((int) (0x00ffffff));
 //BA.debugLineNum = 56;BA.debugLine="txtPassword.TextColor = 0xff000000";
_txtpassword.setTextColor((int) (0xff000000));
 //BA.debugLineNum = 57;BA.debugLine="txtPassword.Text = \"\"";
...
public String  _txtid_click() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub txtID_click()";
 //BA.debugLineNum = 89;BA.debugLine="End Sub";
return "";
}
public String  _txtpassword_click() throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Sub txtPassword_click()";
