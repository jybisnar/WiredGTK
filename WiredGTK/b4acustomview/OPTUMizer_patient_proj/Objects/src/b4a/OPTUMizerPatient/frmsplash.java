...
public class frmsplash extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.OPTUMizerPatient.frmsplash");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.OPTUMizerPatient.frmsplash.class).invoke(this, new Object[] {null});
        else
...
b4a.OPTUMizerPatient.frmcontrols _x = null;
 ...
 //BA.debugLineNum = 54;BA.debugLine="Dim x As frmcontrols";
_x = new b4a.OPTUMizerPatient.frmcontrols();
 //BA.debugLineNum = 55;BA.debugLine="x=Starter.frmcontrols1";
_x = (b4a.OPTUMizerPatient.frmcontrols)(_starter._frmcontrols1 /*Object*/ );
 //BA.debugLineNum = 56;BA.debugLine="x.Visible=True";
_x._setvisible /*boolean*/ (__c.True);
 //BA.debugLineNum = 57;BA.debugLine="setVisible(False)";
