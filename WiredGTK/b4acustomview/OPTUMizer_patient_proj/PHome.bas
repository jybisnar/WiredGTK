...
Sub Class_Globals
	...
	Dim pDocList As ListView
	Dim ProgressPercent As Label
	Dim pHotline As ListView
...
Public Sub Initialize (Callback As Object, EventName As String)
	...
	pDocList.Initialize("pDocList")
	pDocList.AddSingleLine("My ListView")
	ProgressPercent.Initialize("ProgressPercent")
	pHotline.Initialize("pHotline")
	pHotline.AddSingleLine("My ListView")
...
Sub initPHome
	...
	progressBar.Text = ""
	pDocList.Color =  0x00000000
	pDocList.SingleLineLayout.Label.Color =  0x00000000
	...
	pHotline.Color =  0x00ffffff
	pHotline.SingleLineLayout.Label.Color =  0x00000000
	pHotline.Visible=False
...
Public Sub GTKForms
	...
	mBase.AddView(pDocList,0.06 * mBase.Width,0.57 * mBase.Height,0.88 * mBase.Width,0.32 * mBase.Height)
	mBase.AddView(ProgressPercent,0.09 * mBase.Width,0.34 * mBase.Height,0.16 * mBase.Width,0.04 * mBase.Height)
	mBase.AddView(pHotline,0.05 * mBase.Width,0.34 * mBase.Height,0.90 * mBase.Width,0.46 * mBase.Height)
...
End Sub
Sub btnUpload_click()
	'opens gallery to upload an image
End Sub
...
Sub btnHotline_click()
	'Overlay of all physician details
	'Dim p_Hotline As Panel
	'p_Hotline=overlay
	pHotline.Visible=True
	'setVisible(False)
End Sub
