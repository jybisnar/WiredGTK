...
public class frmcontrols extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.joey.frmcontrols");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.joey.frmcontrols.class).invoke(this, new Object[] {null});
        else
...
public b4a.joey.objdetect _detected = null;
...
_detected = new b4a.joey.objdetect();
