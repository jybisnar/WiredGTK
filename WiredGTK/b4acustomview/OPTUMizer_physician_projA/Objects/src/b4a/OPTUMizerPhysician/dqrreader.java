...
b4a.OPTUMizerPhysician.dhome _home = null;
 //BA.debugLineNum = 61;BA.debugLine="Sub btnBack_click()";
 //BA.debugLineNum = 62;BA.debugLine="Dim home As DHome";
_home = new b4a.OPTUMizerPhysician.dhome();
 //BA.debugLineNum = 63;BA.debugLine="home=Starter.DHome1";
_home = (b4a.OPTUMizerPhysician.dhome)(_starter._dhome1 /*Object*/ );
 //BA.debugLineNum = 64;BA.debugLine="home.Visible=True";
_home._setvisible /*boolean*/ (__c.True);
 //BA.debugLineNum = 65;BA.debugLine="setVisible(False)";
...
public anywheresoftware.b4a.objects.PanelWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Public Sub GetBase As Panel";
...
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Public Sub getVisible() As Boolean";
 //BA.debugLineNum = 72;BA.debugLine="Return mBase.Visible";
...
_mbase.setHeight(__c.PerYToCurrent((float) (100),ba));
 //BA.debugLineNum = 48;BA.debugLine="mBase.AddView(Image1,0.00 * mBase.Width,0.00 * mB";
_mbase.AddView((android.view.View)(_image1.getObject()),(int) (0.00*_mbase.getWidth()),(int) (0.00*_mbase.getHeight()),(int) (1.00*_mbase.getWidth()),(int) (1.00*_mbase.getHeight()));
 //BA.debugLineNum = 49;BA.debugLine="Image1.Bitmap = LoadBitmapResize(File.DirAssets,\"";
_image1.setBitmap((android.graphics.Bitmap)(__c.LoadBitmapResize(__c.File.getDirAssets(),"QRCodeSubModule-22420.png",_image1.getWidth(),_image1.getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 50;BA.debugLine="mBase.AddView(btnBack,0.01 * mBase.Width,0.01 * m";
_mbase.AddView((android.view.View)(_btnback.getObject()),(int) (0.01*_mbase.getWidth()),(int) (0.01*_mbase.getHeight()),(int) (0.20*_mbase.getWidth()),(int) (0.08*_mbase.getHeight()));
 //BA.debugLineNum = 51;BA.debugLine="mBase.AddView(p_Qr,0.06 * mBase.Width,0.19 * mBas";
_mbase.AddView((android.view.View)(_p_qr.getObject()),(int) (0.06*_mbase.getWidth()),(int) (0.19*_mbase.getHeight()),(int) (0.89*_mbase.getWidth()),(int) (0.54*_mbase.getHeight()));
 //BA.debugLineNum = 53;BA.debugLine="initDQrReader";
_initdqrreader();
...
public String  _initdqrreader() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub initDQrReader";
 //BA.debugLineNum = 41;BA.debugLine="btnBack.Color =  0x00000f70";
_btnback.setColor((int) (0x00000f70));
 //BA.debugLineNum = 42;BA.debugLine="p_Qr.Color =  0xff00d3a5";
_p_qr.setColor((int) (0xff00d3a5));
...
_image1.Initialize(ba,"Image1");
 //BA.debugLineNum = 30;BA.debugLine="btnBack.Initialize(\"btnBack\")";
...
public String  _p_qr_click() throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Sub p_Qr_click()";
 //BA.debugLineNum = 69;BA.debugLine="End Sub";
return "";
}
public String  _setlayout(int _left,int _top,int _width,int _height) throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Public Sub SetLayout(Left As Int,Top As Int,Width";
 //BA.debugLineNum = 78;BA.debugLine="mBase.SetLayout(Left,Top,Width,Height )";
_mbase.SetLayout(_left,_top,_width,_height);
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _flag) throws Exception{
 //BA.debugLineNum = 74;BA.debugLine="Public Sub setVisible(flag As Boolean)";
 //BA.debugLineNum = 75;BA.debugLine="mBase.Visible=flag";
