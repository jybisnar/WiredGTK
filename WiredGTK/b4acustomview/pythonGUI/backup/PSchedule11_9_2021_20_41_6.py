...
class Handler(object):
	...
	def GTKForms(self):
		...
		self.Label1=forms
		self.create("{'Height': '30', 'Font': 'Sans Bold 10', 'Tag': '', 'BackColor': '(1,1,1,1)', 'Enable': 'True', 'Alignment': '', 'Events': '[]', 'Width': '100', 'ForeColor': '(0,0,0,1)', 'ParentsType': 'Frame', 'Picture': '', 'Help': '', 'Visible': 'True', 'Top': '20', 'Name': 'Label1', 'Var': '', 'Left': '160', 'Text': 'Your Schedule'}","Label","Frame1","[]")
