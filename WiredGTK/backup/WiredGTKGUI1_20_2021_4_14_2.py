...
class Handler(usercontrol):
	...
	def GTKForms(self):
		self.create("{'Name': 'btnNew', 'Text': '', 'Top': '15', 'Left': '0', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '17.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'NewActivex', 'Text': '', 'Top': '0', 'Left': '55', 'Width': '50', 'Height': '50', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '2.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnOpen', 'Text': '', 'Top': '0', 'Left': '115', 'Width': '50', 'Height': '35', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '3.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'imclose', 'Text': '', 'Top': '0', 'Left': '175', 'Width': '50', 'Height': '35', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '4.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'imagecloseall', 'Text': '', 'Top': '0', 'Left': '235', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '5.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'btnExample', 'Text': '', 'Top': '0', 'Left': '295', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '6.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnSave', 'Text': '', 'Top': '0', 'Left': '355', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '7.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnSaveAs', 'Text': '', 'Top': '0', 'Left': '415', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '8.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnCut', 'Text': '', 'Top': '0', 'Left': '485', 'Width': '35', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '9.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnCopy', 'Text': '', 'Top': '0', 'Left': '540', 'Width': '50', 'Height': '40', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '10.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnPaste', 'Text': '', 'Top': '-5', 'Left': '600', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '11.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'btnDelete', 'Text': '', 'Top': '-5', 'Left': '670', 'Width': '50', 'Height': '40', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '12.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'run', 'Text': '', 'Top': '0', 'Left': '725', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '13.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'btn_stop', 'Text': '', 'Top': '0', 'Left': '780', 'Width': '50', 'Height': '40', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '14.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'Properties', 'Text': '', 'Top': '90', 'Left': '775', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '15.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'Widget', 'Text': '', 'Top': '125', 'Left': '765', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '16.png', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'clearbreak', 'Text': '', 'Top': '125', 'Left': '815', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': 'pdb.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'usercontrolbuf', 'Text': 'Layout1', 'Top': '100', 'Left': '0', 'Width': '305', 'Height': '380', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.16821630082508665, 0.7205644320921178, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Layout","usercontrol","[]")
		self.create("{'Name': 'lblFileName', 'Text': 'Open Project Folder', 'Top': '70', 'Left': '0', 'Width': '100', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'Button1', 'Text': '', 'Top': '40', 'Left': '375', 'Width': '45', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '19.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'Button2', 'Text': '', 'Top': '40', 'Left': '435', 'Width': '50', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '21.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'Button3', 'Text': '', 'Top': '40', 'Left': '580', 'Width': '75', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '22.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'ScrolledWindow1', 'Text': 'ScrolledWindow1', 'Top': '595', 'Left': '305', 'Width': '1050', 'Height': '115', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.2283765486683038, 0.9218062664839296, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","ScrolledWindow","usercontrol","[]")
		self.create("{'Name': 'Button4', 'Text': '', 'Top': '40', 'Left': '665', 'Width': '80', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '23.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'Button5', 'Text': '', 'Top': '40', 'Left': '505', 'Width': '60', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '25.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'Label1', 'Text': '>>', 'Top': '550', 'Left': '365', 'Width': '20', 'Height': '25', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': '', 'Alignment': ''}","Label","usercontrol","[]")
		self.create("{'Name': 'Button8', 'Text': '', 'Top': '40', 'Left': '200', 'Width': '60', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '18.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'Button9', 'Text': '', 'Top': '40', 'Left': '270', 'Width': '95', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '20.png', 'Events': '[clicked]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","Button","usercontrol","[['clicked', 'self,e']]")
		self.create("{'Name': 'ctlmenuBar1', 'Text': 'ctlmenuBar1', 'Top': '0', 'Left': '0', 'Width': '265', 'Height': '20', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.5842975292398256, 0.870020511207372, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[clicked]', 'Tag': 'Activex', 'ParentsType': '', 'Var': '', 'Help': ''}","ctlmenuBar","usercontrol","[['clicked', 'self,caption']]")
		self.create("{'Name': 'FileChooser1', 'Text': 'FileChooser1', 'Top': '180', 'Left': '525', 'Width': '30', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.05066897811702087, 0.903619944129897, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': 'Activex', 'ParentsType': '', 'Var': '', 'Help': ''}","FileChooser","usercontrol","[]")
		self.create("{'Name': 'MsgBox1', 'Text': 'MsgBox1', 'Top': '80', 'Left': '325', 'Width': '30', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.8954106704968187, 0.5155371000812619, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': 'Activex', 'ParentsType': '', 'Var': '', 'Help': '', 'usercontrolproperty': 'sample only'}","MsgBox","usercontrol","[]")
		self.create("{'Name': 'EventBox1', 'Text': 'EventBox1', 'Top': '550', 'Left': '335', 'Width': '30', 'Height': '25', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.8967267378254482, 0.47491483413434776, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","EventBox","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'EventBox2', 'Text': 'EventBox2', 'Top': '550', 'Left': '305', 'Width': '30', 'Height': '25', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0.8967267378254482,0 , 0.47491483413434776, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[button-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","EventBox","usercontrol","[['button-release-event', 'self,event,e']]")
		self.create("{'Name': 'ctlanouncement1', 'Text': 'ctlanouncement1', 'Top': '480', 'Left': '0', 'Width': '305', 'Height': '230', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.33298230352382896, 0.11104401292885702, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': 'Activex', 'ParentsType': '', 'Var': '', 'Help': ''}","ctlanouncement","usercontrol","[]")
		self.create("{'Name': 'Label2', 'Text': '-Debug Probe-', 'Top': '575', 'Left': '305', 'Width': '80', 'Height': '20', 'Visible': 'True', 'Enable': 'True', 'Font': '9', 'BackColor': '(0.07,0.71,0.90,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': '', 'Alignment': 'CENTER'}","Label","usercontrol","[]")
		self.create("{'Name': 'Entry1', 'Text': 'print(\"Hello\")', 'Top': '550', 'Left': '385', 'Width': '970', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[key-press-event, key-release-event]', 'Tag': '', 'ParentsType': '', 'Var': '', 'Help': ''}","SourceView","usercontrol","[['key-press-event', 'self,event,e'], ['key-release-event', 'self,event,e']]")
		self.create("{'Name': 'cboFilename', 'Text': 'ComboBoxText1', 'Top': '0', 'Left': '0', 'Width': '295', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[changed]', 'Tag': '', 'ParentsType': 'Layout', 'Var': '', 'Help': ''}","ComboBoxText","usercontrolbuf","[['changed', 'self,e']]")
		self.create("{'Name': 'cboObject', 'Text': 'ComboBoxText1', 'Top': '30', 'Left': '0', 'Width': '235', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[changed]', 'Tag': '', 'ParentsType': 'Layout', 'Var': '', 'Help': ''}","ComboBoxText","usercontrolbuf","[['changed', 'self,e']]")
		self.create("{'Name': 'btnhighlight', 'Text': 'Hide', 'Top': '30', 'Left': '235', 'Width': '60', 'Height': '30', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(1,1,1,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[clicked]', 'Tag': '', 'ParentsType': 'Layout', 'Var': '', 'Help': ''}","Button","usercontrolbuf","[['clicked', 'self,e']]")
		self.create("{'Name': 'scrolledwindow1', 'Text': 'ScrolledWindow1', 'Top': '60', 'Left': '0', 'Width': '295', 'Height': '319', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0, 0.10381282458180208, 0.8874311878391989, 0.5)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': '', 'ParentsType': 'Layout', 'Var': '', 'Help': ''}","ScrolledWindow","usercontrolbuf","[]")
		self.create("{'Name': 'Entry2', 'Text': '', 'Top': '10', 'Left': '20', 'Width': '170', 'Height': '55', 'Visible': 'True', 'Enable': 'True', 'Font': '', 'BackColor': '(0,0,0,1)', 'ForeColor': '(0,0,0,1)', 'Picture': '', 'Events': '[[, ]]', 'Tag': '', 'ParentsType': 'ScrolledWindow', 'Var': '', 'Help': ''}","SourceView","ScrolledWindow1","[]")
	def Widget(self):
	...
	def AdjustView(self):
		if self.view==False:
			...
			forms(self.currentform.Widget()).Height-=120
	...
	def OpenFile(self,_path=''):
		...
		for i,a in enumerate(self.frmForm):
			if fnameGlade==self.cboFilename.Text:		
				return
		...
		if FileExist('b4a.txt')==True:
			...
			for a in self.currentform.addedobj.lst:
				...
				if a.Name!="Activity" and a.Name!="mBase":
					...
					3.1 and 2 not needed anymore, this produces filename_new.bas if file already exist, just copy all code in "filename_new.bas: related to the new widget added within wiredgtk
					'''
